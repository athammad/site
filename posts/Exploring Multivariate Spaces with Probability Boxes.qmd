...
fontsize: 1.5em
image-options:
  width: 50%  # or specify the width in percentage, e.g., "50%"
  height: auto  # this will maintain the aspect ratio

---

::: justify
In a previous post I introduced the idea of a [“probability box.”](https://athsas.com/posts/Probability%20Box%20with%20Kernel%20Density%20Estimation.html) Well, after After several intense months of hard work, I am thrilled to announce that my idea has been transformed into a fully functional R library, now available on **CRAN** for everyone interested in answering probabilistic questions!
